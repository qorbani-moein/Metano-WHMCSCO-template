...
<div class="card">
    <div class="card-body">
        <h1 clas="text-primary">
            {$kbarticle.title}
            <a href="#" class="btn btn-default btn-sm float-left" onclick="window.print();return false">
        ...
        <ul class="list-inline">
            ...
            {/if}
            <li class="list-inline-item text-sm pr-3 text-muted text"><i class="fas fa-thumbs-up mr-2"></i>{$kbarticle.useful}</li>
        </ul>
