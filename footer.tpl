...
{if $templatefile != 'clientregister' && $templatefile != 'login' && $templatefile != 'logout' && $templatefile != 'pwreset' && $templatefile != 'password-reset-container'}
	...
	<div class="container">
		<div class="footer-block-col row m-0">
			<div class="footer-block-col-1st col-xs-12 col-md-6">
				<div>
					<p class="mb-0">نوآور باش</p>
					<p class="mb-0">ما بهترین راه‌حل را برای رشد و توسعه کسب و کار شما ارائه می‌دهیم.</p>
				</div>
			</div>
			<div class="footer-block-col-2nd col-xs-12 col-md-6">
				<p class="mb-0">۰۹۱۵۴۱۰۴۱۰۱</p>
