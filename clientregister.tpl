...
{if !$registrationDisabled}
    <div id="registration">
        <form method="post" class="Registr100-form validate-form" action="{$smarty.server.PHP_SELF}" role="form" name="orderfrm" id="frmCheckout">
            ...
            <div class="mb-4">
                <p class="text-muted mb-0  text-right">برای عضویت در مجموعه WHMCS فارسی، لطفا فرم زیر با با دقت تکمیل بفرمایید</p>
            </div>
                        <div class="row">
                            <div class="col-sm-6">
                ...
                <div class="login-boder mb-4">
                    <div class="login-body ">
                        ...
                        <div id="containerPassword" class="row{if $remote_auth_prelinked && $securityquestions} hidden{/if}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <button type="button" class="btn btn-danger btn-sm btn-sm-block generate-password" data-targetfields="inputNewPassword1,inputNewPassword2">
            ...
            {if $showMarketingEmailOptIn}
                <div class="alert alert-primary mb-4">
                        <h5>{lang key='emailMarketing.joinOurMailingList'}</h5>
            ...
            {if $accepttos}
                <p class="text-center">
                    <label class="form-check">
                        ...
                        <a href="{$tosurl}" target="_blank">{lang key='ordertos'}</a> {lang key='ordertosagreement'}
                    </label>
                </p>
            {/if}
            ...
            <p align="center">
                ...
                <a href="{$WEB_ROOT}/login.php" class="btn btn-large btn-success">وارد حساب خود شوید</a>
            </p>
        </form>

    </div>
{/if}
				<div class="login100-more" style="background-image: url('{$WEB_ROOT}/templates/{$template}/whmcsco/img/Frame 709.svg');">
				</div>
			</div>
		</div>
	</div>
