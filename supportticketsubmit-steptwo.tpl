...
<div class="card">
    <div class="card-body extra-padding">
        ...
        <p class="text-center">
            <button type="submit" id="openTicketSubmit" class="btn btn-info{$captcha->getButtonClass($captchaForm)}">
                {lang key='supportticketsticketsubmit'}
            </button>
            <a href="supporttickets.php" class="btn btn-warning bg">{lang key='cancel'}</a>
        </p>
